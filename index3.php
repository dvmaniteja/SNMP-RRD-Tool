...
$link10 = mysqli_connect("$host","$username","$password","$database");
		...
		if(isset($_GET['delete']))
    {
		...
		$result11 = mysqli_query($link10,"DELETE FROM mani_INTERFACES where IP='$x' and PORT='$y' and COMMUNITY='$z'");
...
<left><h1 style="font-family:Trebuchet MS;font-size:150%">Select a device to delete</h1></left>
...
<a href="index1.php"> Click to view graphs </a> 
